 ...
 * doors as the 404. No apology, no "Oops" — a failed render is a fact.
 */
        ...
        <section className="lq-sec">
          ...
          <div style={{ display: "grid", gap: "var(--space-2)" }}>
            <h1 className="lq-phead__title">
              {ar ? "مش قادرين نعرض الصفحة دي" : "This page did not load"}
            </h1>
            ...
            {/* The digest is the ONLY identifier that survives a production
                build, and it is what support would ask for. Latin figures in
                the mono face, like every other reference number in the app. */}
            {error.digest ? (
              <p className="lq-hint">
